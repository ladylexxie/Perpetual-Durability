...
public class PerpetuateCommand {
	...
	private static final DynamicCommandExceptionType ERROR_NO_ITEM = new DynamicCommandExceptionType(e -> Component.translatable("commands.perpetual_durability.perpetuate.failed.itemless", e));
	private static final DynamicCommandExceptionType ERROR_INCOMPATIBLE = new DynamicCommandExceptionType(e -> Component.translatable("commands.perpetual_durability.perpetuate.failed.incompatible", e));
